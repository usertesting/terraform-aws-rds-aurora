locals {
  ...
  master_password               = var.create_cluster && var.create_random_password ? (var.db_creds_path == "" ? random_password.master_password[0].result : local.stored_creds) : var.master_password
